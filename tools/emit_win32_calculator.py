...
def emit_program(e: Emitter, a: X86) -> None:
    ...
    emit_add_scaled_digit(e, a)
    emit_current_value(e, a)
    emit_trim_fraction_zeros(e, a)
    emit_format_number(e, a)
    emit_apply_pending_operation(e, a)
    emit_input_digit(e, a)
    emit_input_operator(e, a)
    emit_calculate_result(e, a)
...
def emit_data(e: Emitter) -> None:
    ...
    emit_wstr(e, "str_overflow", "Overflow")
    emit_wstr(e, "str_divide_zero", "Cannot divide by zero")
    ...
    emit_wstr(e, "fmt_pos_int", "%d")
    emit_wstr(e, "fmt_neg_int", "-%d")
    emit_wstr(e, "fmt_pos_frac", "%d.%04d")
    emit_wstr(e, "fmt_neg_frac", "-%d.%04d")
...
def main() -> None:
    ...
    last_iat = e.labels["iat_gdi32_dll"] + (2 * 4)
